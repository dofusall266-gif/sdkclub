...
const fr = {
    ...
    daily: {
      ...
      submitTimeout: "Ça prend plus de temps que prévu. Vérifiez votre connexion et réessayez.",
      submitInvalidScore: "Ce score n'a pas pu être validé. Réessayez en terminant une nouvelle grille.",
...
const en: Dictionary = {
    ...
    daily: {
      ...
      submitTimeout: "This is taking longer than expected. Check your connection and try again.",
      submitInvalidScore: "This score couldn't be validated. Try again after finishing a new grid.",
